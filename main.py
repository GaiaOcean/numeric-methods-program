...
if __name__ == "__main__":
    ...
    f = sp.sympify(funcao, locals={'e': sp.E, 'pi': sp.pi})
    ...
    print()
    max_segunda_derivada = methods.maxSegundaDerivada(funcao,f,a,b,passo,num_casas_decimais,num_trapezios)
    print()
    ...
    print()
    intervalo_final = methods.respostaFinal(funcao,f,a,b,area,num_casas_decimais,erro_total)
